...
Begin VB.Form Form5 
   ...
   Caption         =   "[Mata Kuliah Kewirausahaan] Aplikasi Presensi Kuliah Dengan RFID"
   ClientHeight    =   6900
   ClientLeft      =   45
   ClientTop       =   690
   ClientWidth     =   7245
...
If Text1.Text = io.KD1 Then
    sqlq1 = "INSERT INTO umum VALUES ('','" & io.KD1 & "','" & io.TG1 & "','" & io.US1 & "',CURRENT_DATE(),'" & io.M4 & "')"
    CN.Execute sqlq1
    CN.Close
    Text1.SetFocus
    Text1.Text = ""
...
ElseIf Text1.Text = io.KD2 Then
    sqlq2 = "INSERT INTO umum VALUES ('','" & io.KD2 & "','" & io.TG2 & "','" & io.US2 & "',CURRENT_DATE(),'" & io.M4 & "')"
    CN.Execute sqlq2
    CN.Close
    Text1.SetFocus
    Text1.Text = ""
